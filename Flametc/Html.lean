  ...
  <body>
    <div class='container'>
      <div class='header clearfix'>
        ...
        <h3 class='text-muted'>FlameTC</h3>
      </div>
      <div id='chart'>
      </div>
      <hr>
...
def output (node : Node) : IO Unit := do
  let outDir : System.FilePath := "build" / "flametc"
  IO.FS.createDirAll outDir
  IO.FS.writeFile (outDir / "data.json") (Lean.toJson node).compress
  IO.FS.writeFile (outDir / "index.html") baseHtml
